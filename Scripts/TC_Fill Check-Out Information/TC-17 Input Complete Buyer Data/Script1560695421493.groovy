...
WebUI.click(findTestObject('Page_Swag Labs/Page_Swag Labs/a_1'))
...
WebUI.setText(findTestObject('Checkout/TC-17/Page_Swag Labs/input_Checkout Your Informatio_14'), 'Data Dummy')
